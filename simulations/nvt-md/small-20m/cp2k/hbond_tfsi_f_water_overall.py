...
def main():
    ...
    data_path = "hbond_elliptical_data_overall_tfsi_f"
    ...
    for (temp, functional), group in project.groupby(("T","Functional")):
        ...
        sel_oxygen_head = 'resname TF2 and element F' ; sel_hydrogen = 'name H1 or name H2' ; sel_oxygen_tail = 'name O5'; list_names_hydrogen = ["H1", "H2"] ; list_names_oxygen_head = ["O1", "O2", "O3", "O4"] ; list_names_oxygen_tail = ["O5"]
