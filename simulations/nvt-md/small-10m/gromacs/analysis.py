...
def main():
    ...
    for (temp, functional), group in project.groupby(("T","Functional")):
        ...
        print("The combined trajectory has {} frames ".format(comb_traj.n_frames,comb_traj.n_frames*5/1000))
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_TFSI-water.pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_C(TFSI)-C(TFSI).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("O(water)-O(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_O(water)-O(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_Li-O(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_S(TFSI)-S(TFSI).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("O(TFSI)-H(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_O(TFSI)-H(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("O(TFSI)-O(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_O(TFSI)-O(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("F(TFSI)-H(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_F(TFSI)-H(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("N(TFSI)-H(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_N(TFSI)-H(water).pdf")
        plt.close()
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("F(TFSI)_O(water).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_F(TFSI)-O(water).pdf")
        plt.close()
       ...
       ##seventeenth RDF is intermolecular S(TFSI) -S(TFSI)
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("intermolecular-S(TFSI)-S(TFSI).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_intermolecular-S(TFSI)-S(TFSI).pdf")
        plt.close()
       ...
       ##eighteenth RDF is intermolecular C(TFSI) -C(TFSI)
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$g(r)$")
        plt.savefig("intermolecular-C(TFSI)-C(TFSI).pdf")
        np.savetxt(
        ...
        plt.xlabel(r"$r$/$\mathrm{\AA}$")
        plt.ylabel("$n(r)$")
        plt.savefig("cdf_intermolecular-C(TFSI)-C(TFSI).pdf")
        plt.close()
