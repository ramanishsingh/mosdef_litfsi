    ...
    for (temp, functional), group in project.groupby(("T","Functional")):
        ...
        for job in group:
            ...
            if full_traj.n_frames>500:
                traj_list.append(full_traj[500:]) # discarding first 0 ps 
        ...
        print("The combined trajectory has {} frames = {} ps ".format(comb_traj.n_frames,comb_traj.n_frames))
        ...
        print('check index', pair_indices_2)
        freud_rdf = freud.density.RDF(bins=n_bins, r_min=r_min, r_max=r_max)
