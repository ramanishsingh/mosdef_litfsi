...
def ellipticalFun(dist,degangle):
    ...
    if ((((dist-0.28)/0.05)**2 + (1/50**2)*(degangle-180)**2) < 1): return True
            ...
            for bonded_H in bond_diction[original_Otail_index]:
               ...
               # print("{}-{} is bonded to {}-{}".format(original_Otail_index,bond.atom1.name, original_H_index,bond.atom2.name))
                ...
                if math.isnan(normal_angle):
                    print("normal angle is nan, skipping loop")
                    continue
                ...
                print("frame is ", frame, "the array is", np.array([[original_Otail_index, original_H_index, original_Ohead_index]]))
